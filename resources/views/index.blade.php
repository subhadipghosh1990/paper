				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						...
						<div class="single-product">
							...
							<div class="productImgHolder position-relative">
								<img src="{{ substr_replace(print_r(json_decode($product->images)[0]->img),"", -1) }}" class="img-fluid" alt="">
							</div>
							...
							<div class="product-details">
								...
								<div class="price clearfix">
									...
									<h6 class="l-through">{{ceil($product->unit_price+$product->unit_price/4)}}</h6>
									<span class="float-right font-italic small">{{$product->product_type}}</span>
								</div>
								...
								<div class="prd-bottom">
									...
									<a href="/product-info/{{$product->id}}" class="social-info">
