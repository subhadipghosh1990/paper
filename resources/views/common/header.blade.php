...
<head>
	...
	<link rel="stylesheet" href="{{URL::to('/')}}/assets/css/nouislider.min.css">
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="/"><img src="{{URL::to('/')}}/assets/img/logo.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<!-- <li class="nav-item"><a href="/user" class="nav-link"><span class="ti-user"></span></a></li> -->

							<li class="nav-item submenu dropdown">
							<a href="#" class="nav-link"><span class="ti-user"></span> User</a>
